...
class Go2Env(LeggedRobot):
    """
    Go2-specific reward extensions on top of the generic LeggedRobot base class.

    In addition to the rewards defined in the base class, we implemted following specific rewards here:
